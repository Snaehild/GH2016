	...
	public static function register_scripts() {
		...
		if ( ! is_admin() ) {
			...
			wp_localize_script( 'wp-color-picker', 'wpColorPickerL10n', array(
				'clear'         => esc_html__( 'Clear', 'crystalskull' ),
				'defaultString' => esc_html__( 'Default', 'crystalskull' ),
				'pick'          => esc_html__( 'Select Color', 'crystalskull' ),
				'current'       => esc_html__( 'Current Color', 'crystalskull' ),
			) );
		}
		...
		wp_localize_script( 'cmb2-scripts', 'cmb2_l10', apply_filters( 'cmb2_localized_data', array(
			...
			'defaults'         => array(
				...
				'date_picker'  => array(
					'changeMonth'     => true,
					'changeYear'      => true,
					'dateFormat'      => esc_html__( 'mm/dd/yy', 'crystalskull' ),
					'dayNames'        => explode( ',', esc_html__( 'Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday', 'crystalskull' ) ),
					'dayNamesMin'     => explode( ',', esc_html__( 'Su, Mo, Tu, We, Th, Fr, Sa', 'crystalskull' ) ),
					'dayNamesShort'   => explode( ',', esc_html__( 'Sun, Mon, Tue, Wed, Thu, Fri, Sat', 'crystalskull' ) ),
					'monthNames'      => explode( ',', esc_html__( 'January, February, March, April, May, June, July, August, September, October, November, December', 'crystalskull' ) ),
					'monthNamesShort' => explode( ',', esc_html__( 'Jan, Feb, Mar, Apr, May, Jun, Jul, Aug, Sep, Oct, Nov, Dec', 'crystalskull' ) ),
					'nextText'        => esc_html__( 'Next', 'crystalskull' ),
					'prevText'        => esc_html__( 'Prev', 'crystalskull' ),
					'currentText'     => esc_html__( 'Today', 'crystalskull' ),
					'closeText'       => esc_html__( 'Done', 'crystalskull' ),
					'clearText'       => esc_html__( 'Clear', 'crystalskull' ),
				),
				'time_picker'  => array(
					'timeOnlyTitle' => esc_html__( 'Choose Time', 'crystalskull' ),
					'timeText'      => esc_html__( 'Time', 'crystalskull' ),
					'hourText'      => esc_html__( 'Hour', 'crystalskull' ),
					'minuteText'    => esc_html__( 'Minute', 'crystalskull' ),
					'secondText'    => esc_html__( 'Second', 'crystalskull' ),
					'currentText'   => esc_html__( 'Now', 'crystalskull' ),
					'closeText'     => esc_html__( 'Done', 'crystalskull' ),
					'timeFormat'    => esc_html__( 'hh:mm TT', 'crystalskull' ),
					'controlType'   => 'select',
					'stepMinute'    => 5,
				),
			),
			'strings' => array(
				'upload_file'  => esc_html__( 'Use this file', 'crystalskull' ),
				'remove_image' => esc_html__( 'Remove Image', 'crystalskull' ),
				'remove_file'  => esc_html__( 'Remove', 'crystalskull' ),
				'file'         => esc_html__( 'File:', 'crystalskull' ),
				'download'     => esc_html__( 'Download', 'crystalskull' ),
				'check_toggle' => esc_html__( 'Select / Deselect All', 'crystalskull' ),
			),
		) ) );
