    ...
    class Radium_Theme_Importer {
        ...
        public function intro_html() {
            ...
            <div style="background-color: #F5FAFD; margin:10px 0;padding: 5px 10px;color: #0C518F;border: 2px solid #CAE0F3; clear:both; width:90%; line-height:18px;">
             ...
             <div style="background-color: #F5FAFD; margin:10px 0;padding: 5px 10px;color: #0C518F;border: 2px solid #CAE0F3; clear:both; width:90%; line-height:18px;"><p class="tie_message_hint">If demo import fails, please calm down and follow these steps:
                 <ul style="padding-left: 20px;list-style-position: inside;list-style-type: square;}">
                      <li>Upgrade latest version of WordPress, PHP version 5.6 or higher.</li>
                      <li> Increase memory limits. You can follow guideline to do this by yourself or contact your server provider to ask for the help to increase following PHP limits:</li>
                      <ul style="padding-left: 20px;list-style-position: inside;list-style-type: square;}">
             ...
             if( !empty($this->imported_demos) ) { ?>
                ...
                <div style="background-color: #FAFFFB; margin:10px 0;padding: 5px 10px;color: #8AB38A;border: 2px solid #a1d3a2; clear:both; width:90%; line-height:18px;">
                    <p><?php _e('Demo already imported', 'crystalskull'); ?></p>
                </div><?php
                //return;
        ...
        public function demo_installer() {
            ...
            if( !empty($this->imported_demos ) ) {
                ...
                $button_text = __('Import Again', 'crystalskull');

            } else {

                $button_text = __('Import Demo Data', 'crystalskull');
        ...
        public function set_demo_theme_options( $file ) {
            ...
            if ( file_exists( $file ) ) {
                ...
                wp_die(
                    __( 'Theme options Import file could not be found. Please try again.', 'crystalskull' ),
                    '',
        ...
        function process_widget_import_file( $file ) {
            ...
            if ( ! file_exists( $file ) ) {
                wp_die(
                    __( 'Widget Import file could not be found. Please try again.', 'crystalskull' ),
                    '',
                    array( 'back_link' => true )
                );
            }
        ...
        public function import_widgets( $data ) {
            ...
            foreach ( $data as $sidebar_id => $widgets ) {
                ...
                if ( isset( $wp_registered_sidebars[$sidebar_id] ) ) {
                    ...
                    $sidebar_message = __( 'Sidebar does not exist in theme (using Inactive)', 'crystalskull' );
                }
                ...
                foreach ( $widgets as $widget_instance_id => $widget ) {
                    ...
                    if ( ! $fail && ! isset( $available_widgets[$id_base] ) ) {
                        ...
                        $widget_message = __( 'Site does not support widget', 'crystalskull' ); // explain why widget not imported
                    }
                    ...
                    if ( ! $fail && isset( $widget_instances[$id_base] ) ) {
                        ...
                        foreach ( $single_widget_instances as $check_id => $check_widget ) {
                            ...
                            if ( in_array( "$id_base-$check_id", $sidebar_widgets ) && (array) $widget == $check_widget ) {
                                ...
                                $widget_message = __( 'Widget already exists', 'crystalskull' ); // explain why widget not imported
                    ...
                    if ( ! $fail ) {
                        ...
                        if ( $sidebar_available ) {
                            ...
                            $widget_message = __( 'Imported', 'crystalskull' );
                        } else {
                            $widget_message_type = 'warning';
                            $widget_message = __( 'Imported to Inactive', 'crystalskull' );
                        }
                    ...
                    $results[$sidebar_id]['widgets'][$widget_instance_id]['title'] = $widget->title ? $widget->title : __( 'No Title', 'crystalskull' ); // show "No Title" if widget instance is untitled
